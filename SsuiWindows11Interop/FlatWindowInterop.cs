...
namespace SsuiWindows11Interop
{
    public static class FlatWindowInterop
    {
        ...
        /// </remarks>
        public static void SetWindows11TitleBar(this FlatWindow w)
        {
        ...
        static void UpdateTitleBarElements(DpiScale dpi, FlatWindow w, IntPtr? windowHandle = null)
        {
            ...
            {
                appWindow.TitleBar.SetDragRectangles(titleBarRect.Subtract(nonClientRects).Select(r => r.ToRectInt32()).ToArray());
            }
        }
