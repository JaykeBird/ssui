...
namespace SolidShineUi
{
    ...
    public class LinkTextBlock : TextBlock
    {
        ...
        /// <summary>The backing styled property for <see cref="TextBrush"/>. See the related property for details.</summary>
        ...
        /// <summary>The backing styled property for <see cref="AutoSetLinkFromText"/>. See the related property for details.</summary>
        ...
        /// <summary>The backing styled property for <see cref="UnderlineOnHighlight"/>. See the related property for details.</summary>
