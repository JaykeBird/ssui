...
namespace SolidShineUi.Utils.MenuUtils
{
    ...
    /// <summary>
    /// A modified version of <see cref="Popup"/> with additional visual properties, used internally with <see cref="Menu"/>.
    /// </summary>
    public class FlatMenuPopup : Popup
    {
        ...
        public static readonly StyledProperty<IBrush?> MenuBackgroundProperty = Menu.MenuBackgroundProperty.AddOwner<FlatMenuPopup>();
        ...
        public static readonly StyledProperty<IBrush?> DisabledBrushProperty = Menu.DisabledBrushProperty.AddOwner<FlatMenuPopup>();
        ...
        public static readonly StyledProperty<IBrush?> PopupBorderBrushProperty = Menu.PopupBorderBrushProperty.AddOwner<FlatMenuPopup>();
        ...
        public static readonly StyledProperty<IBrush?> HighlightSubitemBrushProperty = Menu.HighlightSubitemBrushProperty.AddOwner<FlatMenuPopup>();
        ...
        public static readonly StyledProperty<IBrush?> HighlightBrushProperty = Menu.HighlightBrushProperty.AddOwner<FlatMenuPopup>();
        ...
        public static readonly StyledProperty<IBrush?> CheckedBrushProperty = Menu.CheckedBrushProperty.AddOwner<FlatMenuPopup>();
        ...
        public static readonly StyledProperty<IBrush?> ClickBrushProperty = Menu.ClickBrushProperty.AddOwner<FlatMenuPopup>();
        ...
        public static readonly StyledProperty<IBrush?> ForegroundProperty = TemplatedControl.ForegroundProperty.AddOwner<FlatMenuPopup>();
        ...
        public static readonly StyledProperty<CornerRadius> MenuCornerRadiusProperty = Menu.MenuCornerRadiusProperty.AddOwner<FlatMenuPopup>();
